...
function generateOTP() {
  ...
  function sendMessage()
  {
    ...
    data: 'sender_id=JODSMS&message=1234 is the OTP verify your mobile number for 8741844917. NEVER SHARE YOUR OTP WITH ANYONE. Jaipur SMS Hub Pvt Ltd&mobile_no=8741844917'
    })
  .then(response => {
