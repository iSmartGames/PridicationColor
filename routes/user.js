...
function generateOTP() {
  ...
  function sendMessage()
  {
    ...
    data: 'sender_id=JODSMS&message=1234 is the OTP verify your mobile number for . NEVER SHARE YOUR OTP WITH ANYONE. Jaipur SMS Hub Pvt Ltd&mobile_no=8058626456%2C8058626456'
    })
  .then(response => {
